...
class HomeInfo(models.Model):
    ...
    gluten_free_logo = models.ImageField(upload_to='main/logos', null=True, blank=True)
    vegan_logo = models.ImageField(upload_to='main/logos', null=True, blank=True)
    natural_logo = models.ImageField(upload_to='main/logos', null=True, blank=True)
    organic_logo = models.ImageField(upload_to='main/logos', null=True, blank=True)
